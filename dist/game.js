...
`;
  var ys = new Set(["id", "require"]);
  var bs = new Set(["add", "load", "update", "draw", "destroy", "inspect"]);
  function kr(i) {
...
` && (M.push(oe), y += m, oe === " " && (ee = M.length)), W = Math.max(W, y), te++;
    ...
    a(Lt, "toWorld");
    function En(e) {
      let n = new Map(), r = {}, u = {}, c = { _id: cr(), hidden: false, paused: false, children: [], parent: null, add(s) {
        if (this !== p.root)
...
`), font: U.fonts[rn], pos: f(r, -r), origin: "botleft", size: 16, width: F() * t.scale * 0.6, lineSpacing: r / 2, fixed: true, styles: { time: { color: E(127, 127, 127) }, info: { color: E(255, 255, 255) }, error: { color: E(255, 0, 127) } } });
  ...
  // code/assets.js
  function loadAssets() {
    loadSprite("bean", "sprites/chilli.png");
    loadSprite("ghosty", "sprites/ghosty.png");
    loadSprite("spike", "sprites/spike.png");
    loadSprite("grass", "sprites/steel.png");
    loadSprite("prize", "sprites/jumpy.png");
    loadSprite("apple", "sprites/apple.png");
    loadSprite("portal", "sprites/portal.png");
    loadSprite("trapdoor", "sprites/sand.png");
    loadSprite("key", "sprites/brock.png");
    loadSprite("background", "sprites/bg.jpg");
