...
`&&(M.push(oe),y+=m,oe===" "&&(ee=M.length)),W=Math.max(W,y),te++}O.push(M),e.width&&(W=e.width);let Ae=[],Oe=f(e.pos||0),_=$e(e.origin||je).scale(.5),se=-_.x*m-(_.x+.5)*(W-m),Ie=-_.y*g-(_.y+.5)*(x-g),ct=0;return O.forEach((oe,Ni)=>{let ji=(W-oe.length*m)*(_.x+.5);oe.forEach((lt,Yi)=>{var nr;let _t=n.map[lt],$i=Yi*m,Xi=Ni*g;if(_t){let Bt={tex:n.tex,quad:new k(_t.x,_t.y,n.qw,n.qh),ch:lt,pos:f(Oe.x+$i+se+ji,Oe.y+Xi+Ie),opacity:e.opacity,color:(nr=e.color)!=null?nr:E(255,255,255),scale:h,angle:0,uniform:e.uniform,fixed:e.fixed};if(e.transform){let ht=typeof e.transform=="function"?e.transform(ct,lt):e.transform;ht&&wn(Bt,ht)}if(r[ct]){let{styles:ht,localIdx:Ki}=r[ct];for(let Hi of ht){let Nt=e.styles[Hi],rr=typeof Nt=="function"?Nt(Ki,lt):Nt;rr&&wn(Bt,rr)}}Ae.push(Bt)}ct+=1})}),{width:W,height:x,chars:Ae}}a(me,"formatText");function Kr(e){we(me(e))}a(Kr,"drawText");function we(e){for(let n of e.chars)pe({tex:n.tex,width:n.tex.width*n.quad.w,height:n.tex.height*n.quad.h,pos:n.pos,scale:n.scale,angle:n.angle,color:n.color,opacity:n.opacity,quad:n.quad,origin:"center",uniform:n.uniform,fixed:n.fixed})}a(we,"drawFormattedText");function yn(){let e=t.gl,n=e.drawingBufferWidth,r=e.drawingBufferHeight,u=F(),c=G();if(En()){let s=window.innerWidth,o=window.innerHeight,d=s/o,h=n/r;if(d>h){let m=window.innerHeight*h;l.viewport={x:(s-m)/2,y:0,width:m,height:o}}else{let m=window.innerWidth/h;l.viewport={x:0,y:(o-m)/2,width:s,height:m}}return}if(i.letterbox){if(!i.width||!i.height)throw new Error("Letterboxing requires width and height defined.");let s=n/r,o=i.width/i.height;if(s>o){i.stretch||(l.width=r*o,l.height=r);let d=r*o,h=r,m=(n-d)/2;e.scissor(m,0,d,h),e.viewport(m,0,d,r),l.viewport={x:m,y:0,width:d,height:r}}else{i.stretch||(l.width=n,l.height=n/o);let d=n,h=n/o,m=(r-h)/2;e.scissor(0,m,d,h),e.viewport(0,m,n,h),l.viewport={x:0,y:m,width:n,height:h}}return}if(i.stretch){if(!i.width||!i.height)throw new Error("Stretching requires width and height defined.");e.viewport(0,0,n,r),l.viewport={x:0,y:0,width:n,height:r};return}l.width=n/t.scale,l.height=r/t.scale,e.viewport(0,0,n,r),l.viewport={x:0,y:0,width:n,height:r}}a(yn,"updateViewport");function F(){return l.width}a(F,"width");function G(){return l.height}a(G,"height"),t.canvas.addEventListener("mousemove",e=>{t.mousePos=f((e.offsetX-l.viewport.x)*F()/l.viewport.width,(e.offsetY-l.viewport.y)*G()/l.viewport.height),t.mouseDeltaPos=f(e.movementX,e.movementY).scale(1/t.scale),t.isMouseMoved=!0}),t.canvas.addEventListener("mousedown",e=>{let n=Ar[e.button];n&&(t.mouseStates[n]="pressed")}),t.canvas.addEventListener("mouseup",e=>{let n=Ar[e.button];n&&(t.mouseStates[n]="released")}),t.canvas.addEventListener("keydown",e=>{let n=Dr[e.key]||e.key.toLowerCase();ws.includes(n)&&e.preventDefault(),n.length===1&&t.charInputted.push(e.key),n==="space"&&t.charInputted.push(" "),e.repeat?(t.isKeyPressedRepeat=!0,t.keyStates[n]="rpressed"):(t.isKeyPressed=!0,t.keyStates[n]="pressed")}),t.canvas.addEventListener("keyup",e=>{let n=Dr[e.key]||e.key.toLowerCase();t.keyStates[n]="released",t.isKeyReleased=!0}),t.canvas.addEventListener("touchstart",e=>{if(!i.touchToMouse)return;e.preventDefault();let n=e.touches[0];t.mousePos=f(n.clientX,n.clientY).scale(1/t.scale),t.mouseStates.left="pressed"}),t.canvas.addEventListener("touchmove",e=>{if(!i.touchToMouse)return;e.preventDefault();let n=e.touches[0];t.mousePos=f(n.clientX,n.clientY).scale(1/t.scale),t.isMouseMoved=!0}),t.canvas.addEventListener("touchend",e=>{!i.touchToMouse||(t.mouseStates.left="released")}),t.canvas.addEventListener("touchcancel",e=>{!i.touchToMouse||(t.mouseStates.left="released")}),t.canvas.addEventListener("touchstart",e=>{[...e.changedTouches].forEach(n=>{p.trigger("onTouchStart",n.identifier,f(n.clientX,n.clientY).scale(1/t.scale))})}),t.canvas.addEventListener("touchmove",e=>{[...e.changedTouches].forEach(n=>{p.trigger("onTouchMove",n.identifier,f(n.clientX,n.clientY).scale(1/t.scale))})}),t.canvas.addEventListener("touchend",e=>{[...e.changedTouches].forEach(n=>{p.trigger("onTouchEnd",n.identifier,f(n.clientX,n.clientY).scale(1/t.scale))})}),t.canvas.addEventListener("contextmenu",function(e){e.preventDefault()}),document.addEventListener("visibilitychange",()=>{switch(document.visibilityState){case"visible":t.skipTime=!0,w.ctx.resume();break;case"hidden":w.ctx.suspend();break}});function K(){return t.mousePos.clone()}a(K,"mousePos");function bn(){return t.mouseDeltaPos.clone()}a(bn,"mouseDeltaPos");function Me(e="left"){return t.mouseStates[e]==="pressed"}a(Me,"isMousePressed");function et(e="left"){return t.mouseStates[e]==="pressed"||t.mouseStates[e]==="down"}a(et,"isMouseDown");function tt(e="left"){return t.mouseStates[e]==="released"}a(tt,"isMouseReleased");function Wt(){return t.isMouseMoved}a(Wt,"isMouseMoved");function Le(e){return e===void 0?t.isKeyPressed:t.keyStates[e]==="pressed"}a(Le,"isKeyPressed");function Mt(e){return e===void 0?t.isKeyPressedRepeat:t.keyStates[e]==="pressed"||t.keyStates[e]==="rpressed"}a(Mt,"isKeyPressedRepeat");function Lt(e){return t.keyStates[e]==="pressed"||t.keyStates[e]==="rpressed"||t.keyStates[e]==="down"}a(Lt,"isKeyDown");function nt(e){return e===void 0?t.isKeyReleased:t.keyStates[e]==="released"}a(nt,"isKeyReleased");function Hr(){return[...t.charInputted]}a(Hr,"charInputted");function rt(){return t.time}a(rt,"time");function xn(){return t.canvas.toDataURL()}a(xn,"screenshot");function vn(e){return e&&(t.canvas.style.cursor=e),t.canvas.style.cursor}a(vn,"cursor");function zr(e=!0){e?Rs(t.canvas):Ws()}a(zr,"fullscreen");function En(){return Boolean(Ms())}a(En,"isFullscreen");function Jr(){cancelAnimationFrame(t.loopID),t.stopped=!0}a(Jr,"quit");let C={inspect:!1,timeScale:1,showLog:!0,fps:()=>t.fpsCounter.fps,objCount(){return p.root.children.length},stepFrame:Hn,drawCalls:()=>l.drawCalls,clearLog:()=>p.logs=[],log:e=>p.logs.unshift(`[${rt().toFixed(2)}].time [${e}].info`),error:e=>p.logs.unshift(`[${rt().toFixed(2)}].time [${e}].error`),curRecording:null,get paused(){return t.paused},set paused(e){t.paused=e,e?w.ctx.suspend():w.ctx.resume()}};function Z(){return t.dt*C.timeScale}a(Z,"dt");function Qr(){return B("mouseWorldPos()","toWorld(mousePos())"),qt(K())}a(Qr,"mouseWorldPos");function Zr(e,n){e.forEach((r,u)=>{p.layers[r]=u+1}),n&&(p.defLayer=n)}a(Zr,"layers");function ei(...e){return e.length>0&&(p.cam.pos=f(...e)),p.cam.pos.clone()}a(ei,"camPos");function ti(...e){return e.length>0&&(p.cam.scale=f(...e)),p.cam.scale.clone()}a(ti,"camScale");function ni(e){return e!==void 0&&(p.cam.angle=e),p.cam.angle}a(ni,"camRot");function ri(e=12){p.cam.shake=e}a(ri,"shake");function it(e){return p.cam.transform.multVec2(e)}a(it,"toScreen");function qt(e){return p.cam.transform.invert().multVec2(e)}a(qt,"toWorld");function Tn(e){let n=new Map,r={},u={},c={_id:lr(),hidden:!1,paused:!1,children:[],parent:null,add(s){if(this!==p.root)throw new Error("Children game object not supported yet");let o=Tn(s);return o.parent=this,o.trigger("add"),Ue(()=>o.trigger("load")),this.children.push(o),o},readd(s){return this.remove(s),this.children.push(s),s},remove(s){let o=this.children.indexOf(s);o!==-1&&(s.parent=null,s.trigger("destroy"),this.children.splice(o,1))},removeAll(s){this.every(s,o=>this.remove(o))},update(){this.paused||(this.revery(s=>s.update()),this.trigger("update"))},draw(){this.hidden||(re(),I(this.pos),ne(this.scale),Qe(this.angle),this.every(s=>s.draw()),this.trigger("draw"),ie())},use(s){if(!s)return;if(typeof s=="string")return this.use({id:s});s.id&&(this.unuse(s.id),n.set(s.id,{}));let o=s.id?n.get(s.id):r;o.cleanups=[];for(let h in s)if(!Ss.has(h)){if(typeof s[h]=="function"){let m=s[h].bind(this);if(Cs.has(h)){o.cleanups.push(this.on(h,m)),o[h]=m;continue}else o[h]=m}else o[h]=s[h];this[h]===void 0&&Object.defineProperty(this,h,{get:()=>o[h],set:m=>o[h]=m,configurable:!0,enumerable:!0})}let d=a(()=>{if(!!s.require){for(let h of s.require)if(!this.c(h))throw new Error(`comp '${s.id}' requires comp '${h}'`)}},"checkDeps");this.exists()?(s.add&&s.add.call(this),s.load&&Ue(()=>s.load.call(this)),d()):s.require&&o.cleanups.push(this.on("add",d))},unuse(s){if(n.has(s)){let o=n.get(s);o.cleanups.forEach(d=>d());for(let d in o)delete o[d]}n.delete(s)},c(s){return n.get(s)},get(s){return this.children.filter(o=>s?o.is(s):!0).sort((o,d)=>{var g,y,x,W,O,M;let h=(y=p.layers[(g=o.layer)!=null?g:p.defLayer])!=null?y:0,m=(W=p.layers[(x=d.layer)!=null?x:p.defLayer])!=null?W:0;return h==m?((O=o.z)!=null?O:0)-((M=d.z)!=null?M:0):h-m})},every(s,o){if(typeof s=="function"&&o===void 0)return this.get().forEach(d=>s(d));if(typeof s=="string"||Array.isArray(s))return this.get(s).forEach(d=>o(d))},revery(s,o){if(typeof s=="function"&&o===void 0)return this.get().reverse().forEach(d=>s(d));if(typeof s=="string"||Array.isArray(s))return this.get(s).reverse().forEach(d=>o(d))},exists(){var s;return this.parent===p.root?!0:(s=this.parent)==null?void 0:s.exists()},is(s){if(s==="*")return!0;if(Array.isArray(s)){for(let o of s)if(!this.c(o))return!1;return!0}else return this.c(s)!=null},on(s,o){return u[s]||(u[s]=new $),u[s].pushd(o)},action(...s){return console.warn("action() is deprecated. Use onUpdate() instead"),this.onUpdate(...s)},trigger(s,...o){u[s]&&u[s].forEach(h=>h.call(this,...o));let d=p.objEvents[s];d&&d.forEach(h=>{this.is(h.tag)&&h.cb(this,...o)})},destroy(){var s;(s=this.parent)==null||s.remove(this)},inspect(){let s={};for(let[o,d]of n)s[o]=d.inspect?d.inspect():null;return s},onUpdate(s){return this.on("update",s)},onDraw(s){return this.on("draw",s)},onDestroy(s){return this.on("destroy",s)}};for(let s of e)c.use(s);return c}a(Tn,"make");function qe(e,n,r){return p.objEvents[e]||(p.objEvents[e]=new $),p.objEvents[e].pushd({tag:n,cb:r})}a(qe,"on");function Pe(e,n){if(typeof e=="function"&&n===void 0)return p.root.onUpdate(e);if(typeof e=="string")return qe("update",e,n)}a(Pe,"onUpdate");function Sn(e,n){if(typeof e=="function"&&n===void 0)return p.root.onDraw(e);if(typeof e=="string")return qe("draw",e,n)}a(Sn,"onDraw");function Cn(e,n,r){let u=qe("collide",e,(o,d,h)=>d.is(n)&&r(o,d,h)),c=qe("collide",n,(o,d,h)=>d.is(e)&&r(d,o,h)),s=Pe(e,o=>{if(!o.area)throw new Error("onCollide() requires the object to have area() component");o._checkCollisions(n,d=>{r(o,d)})});return()=>[u,c,s].forEach(o=>o())}a(Cn,"onCollide");function Rn(e,n){return typeof e=="function"?Ot(e):Pe(e,r=>{if(!r.area)throw new Error("onClick() requires the object to have area() component");r.isClicked()&&n(r)})}a(Rn,"onClick");function Wn(e,n,r){return Pe(e,u=>{if(!u.area)throw new Error("onHover() requires the object to have area() component");u.isHovering()?n(u):r&&r(u)})}a(Wn,"onHover");function Mn(e,n){return new Promise(r=>{p.timers.push(new fe(e,()=>{n&&n(),r()}))})}a(Mn,"wait");function ii(e,n){let r=!1,u=a(()=>{r||(n(),Mn(e,u))},"newF");return u(),()=>r=!0}a(ii,"loop");function Pt(e,n){if(Array.isArray(e)){let r=e.map(u=>Pt(u,n));return()=>r.forEach(u=>u())}return p.on("input",()=>Lt(e)&&n())}a(Pt,"onKeyDown");function H(e,n){if(Array.isArray(e)){let r=e.map(u=>H(u,n));return()=>r.forEach(u=>u())}else return typeof e=="function"?p.on("input",()=>Le()&&e()):p.on("input",()=>Le(e)&&n())}a(H,"onKeyPress");function Dt(e,n){if(Array.isArray(e)){let r=e.map(u=>Dt(u,n));return()=>r.forEach(u=>u())}else return typeof e=="function"?p.on("input",()=>Le()&&e()):p.on("input",()=>Mt(e)&&n())}a(Dt,"onKeyPressRepeat");function At(e,n){if(Array.isArray(e)){let r=e.map(u=>At(u,n));return()=>r.forEach(u=>u())}else return typeof e=="function"?p.on("input",()=>nt()&&e()):p.on("input",()=>nt(e)&&n())}a(At,"onKeyRelease");function Ln(e,n){return typeof e=="function"?p.on("input",()=>et()&&e(K())):p.on("input",()=>et(e)&&n(K()))}a(Ln,"onMouseDown");function Ot(e,n){return typeof e=="function"?p.on("input",()=>Me()&&e(K())):p.on("input",()=>Me(e)&&n(K()))}a(Ot,"onMousePress");function qn(e,n){return typeof e=="function"?p.on("input",()=>tt()&&e(K())):p.on("input",()=>tt(e)&&n(K()))}a(qn,"onMouseRelease");function Pn(e){return p.on("input",()=>Wt()&&e(K(),bn()))}a(Pn,"onMouseMove");function Dn(e){return p.on("input",()=>Hr().forEach(n=>e(n)))}a(Dn,"onCharInput");function An(e){return p.on("onTouchStart",e)}a(An,"onTouchStart");function On(e){return p.on("onTouchMove",e)}a(On,"onTouchMove");function In(e){return p.on("onTouchEnd",e)}a(In,"onTouchEnd");function Vn(){H("f1",()=>{C.inspect=!C.inspect}),H("f2",()=>{C.clearLog()}),H("f8",()=>{C.paused=!C.paused}),H("f7",()=>{C.timeScale=ge(z(C.timeScale-.2,0,2),1)}),H("f9",()=>{C.timeScale=ge(z(C.timeScale+.2,0,2),1)}),H("f10",()=>{C.stepFrame()}),H("f5",()=>{$t(xn(),"kaboom.png")}),H("f6",()=>{C.curRecording?(C.curRecording.download(),C.curRecording=null):C.curRecording=jn()})}a(Vn,"enterDebugMode");function Fn(){H("b",cn)}a(Fn,"enterBurpMode");function kn(e){return e!==void 0&&(p.gravity=e),p.gravity}a(kn,"gravity");function si(e,n){}a(si,"regCursor");function Gn(e,n){return{target:e,displacement:n,isTop:()=>n.y>0,isBottom:()=>n.y<0,isLeft:()=>n.x>0,isRight:()=>n.x<0}}a(Gn,"makeCollision");function st(...e){return{id:"pos",pos:f(...e),moveBy(...n){var o;let r=f(...n),u=r.x,c=r.y,s=null;if(this.solid&&((o=this.area)==null?void 0:o.shape)==="rect"){let d=this.worldArea();p.root.every(h=>{var Oe;if(!this.exists()||h===this||!h.solid||((Oe=h.area)==null?void 0:Oe.shape)!=="rect")return;let m=h.worldArea(),g=yt(m,d);if(ae(g,f(0))){let _=Math.min(Math.abs(g.p1.x),Math.abs(g.p2.x),Math.abs(g.p1.y),Math.abs(g.p2.y)),se=(()=>{switch(_){case Math.abs(g.p1.x):return f(_,0);case Math.abs(g.p2.x):return f(-_,0);case Math.abs(g.p1.y):return f(0,_);case Math.abs(g.p2.y):return f(0,-_)}})();this.pos=this.pos.sub(se),d=this.worldArea(),g=yt(m,d)}let y={p1:f(0),p2:f(u,c)},x=1,W=g.p1,O=f(g.p1.x,g.p2.y),M=g.p2,ee=f(g.p2.x,g.p1.y),te=0,Ae={right:{p1:W,p2:O},top:{p1:O,p2:M},left:{p1:M,p2:ee},bottom:{p1:ee,p2:W}};for(let _ in Ae){let se=Ae[_];if(u===0&&se.p1.x===0&&se.p2.x===0||c===0&&se.p1.y===0&&se.p2.y===0){x=1;break}let Ie=Qt(y,se);Ie!=null&&(te++,Ie<x&&(x=Ie))}if(x<1&&!(x===0&&te==1&&!ae(g,f(u,c)))){let _=f(-u*(1-x),-c*(1-x));u*=x,c*=x,s=Gn(h,_)}})}return this.pos.x+=u,this.pos.y+=c,s&&(this.trigger("collide",s.target,s),s.target.trigger("collide",this,Gn(this,s.displacement.scale(-1)))),s},move(...n){return this.moveBy(f(...n).scale(Z()))},moveTo(...n){if(typeof n[0]=="number"&&typeof n[1]=="number")return this.moveTo(f(n[0],n[1]),n[2]);let r=n[0],u=n[1];if(u===void 0){this.pos=f(r);return}let c=r.sub(this.pos);if(c.len()<=u*Z()){this.pos=f(r);return}this.move(c.unit().scale(u))},screenPos(){return this.fixed?this.pos:it(this.pos)},inspect(){return`(${Math.round(this.pos.x)}, ${Math.round(this.pos.y)})`}}}a(st,"pos");function ot(...e){return e.length===0?ot(1):{id:"scale",scale:f(...e),scaleTo(...n){this.scale=f(...n)},inspect(){return typeof this.scale=="number"?`${ge(this.scale,2)}`:`(${ge(this.scale.x,2)}, ${ge(this.scale.y,2)})`}}}a(ot,"scale");function oi(e){return{id:"rotate",angle:e!=null?e:0,inspect(){return`${Math.round(this.angle)}`}}}a(oi,"rotate");function ai(...e){return{id:"color",color:E(...e),inspect(){return this.color.str()}}}a(ai,"color");function ge(e,n){return Number(e.toFixed(n))}a(ge,"toFixed");function ui(e){return{id:"opacity",opacity:e!=null?e:1,inspect(){return`${ge(this.opacity,2)}`}}}a(ui,"opacity");function It(e){if(!e)throw new Error("please define an origin");return{id:"origin",origin:e,inspect(){return typeof this.origin=="string"?this.origin:this.origin.str()}}}a(It,"origin");function ci(e){return{id:"layer",layer:e,inspect(){var n;return(n=this.layer)!=null?n:p.defLayer}}}a(ci,"layer");function li(e){return{id:"z",z:e,inspect(){return`${this.z}`}}}a(li,"z");function hi(e,n){return{id:"follow",require:["pos"],follow:{obj:e,offset:n!=null?n:f(0)},add(){e.exists()&&(this.pos=this.follow.obj.pos.add(this.follow.offset))},update(){e.exists()&&(this.pos=this.follow.obj.pos.add(this.follow.offset))}}}a(hi,"follow");function di(e,n){let r=typeof e=="number"?L.fromAngle(e):e.unit();return{id:"move",require:["pos"],update(){this.move(r.scale(n))}}}a(di,"move");function Vt(e={}){let n=0,r=!1;return{id:"outview",require:["pos","area"],isOutOfView(){var s;let u=f((s=e.offset)!=null?s:0),c=new Be(f(0,0).sub(u),f(F(),G()).add(u));return!gt(this.screenArea(),c)},onExitView(u){return this.on("exitView",u)},onEnterView(u){return this.on("enterView",u)},update(){if(this.isOutOfView()){if(r||(this.trigger("exitView"),r=!0),e.delay&&(n+=Z(),n<e.delay))return;e.hide&&(this.hidden=!0),e.pause&&(this.paused=!0),e.destroy&&this.destroy()}else r&&(this.trigger("enterView"),r=!1),n=0,e.hide&&(this.hidden=!1),e.pause&&(this.paused=!1)},inspect(){return this.isOutOfView()}}}a(Vt,"outview");function fi(e={}){return typeof e=="number"?(B("clean(time)","cleanup({ delay: time })"),D(P({},Vt({destroy:!0,delay:e})),{id:"cleanup"})):D(P({},Vt({destroy:!0,onExitView:e.onCleanup,offset:e.offset,delay:e.delay})),{id:"cleanup"})}a(fi,"cleanup");function pi(e={}){var r,u;let n={};return{id:"area",add(){this.area.cursor&&this.onHover(()=>vn(this.area.cursor))},area:{shape:"rect",offset:(r=e.offset)!=null?r:f(0),width:e.width,height:e.height,scale:(u=e.scale)!=null?u:f(1),cursor:e.cursor},isClicked(){return Me()&&this.isHovering()},isHovering(){let c=this.fixed?K():qt(K());return this.hasPoint(c)},isColliding(c){if(!c.area||!c.exists())return!1;let s=this.worldArea(),o=c.worldArea();return rn(s,o)},isTouching(c){if(!c.area||!c.exists())return!1;let s=this.worldArea(),o=c.worldArea();return br(s,o)},onClick(c){return this.onUpdate(()=>{this.isClicked()&&c()})},onHover(c,s){return this.onUpdate(()=>{this.isHovering()?c():s&&s()})},onCollide(c,s){let o=this.onUpdate(()=>this._checkCollisions(c,s)),d=this.on("collide",(h,m)=>h.is(c)&&s(h,m));return()=>[o,d].forEach(h=>h())},clicks(...c){return B("clicks()","onClick()"),this.onClick(...c)},hovers(...c){return B("hovers()","onHover()"),this.onHover(...c)},collides(...c){return B("collides()","onCollide()"),this.onCollide(...c)},hasPoint(c){return Ut(this.worldArea(),c)},pushOut(c){var g;if(c===this||((g=c.area)==null?void 0:g.shape)!=="rect")return null;let s=this.worldArea(),o=c.worldArea(),d=yt(s,o);if(!ae(d,f(0)))return null;let h=Math.min(Math.abs(d.p1.x),Math.abs(d.p2.x),Math.abs(d.p1.y),Math.abs(d.p2.y)),m=(()=>{switch(h){case Math.abs(d.p1.x):return f(h,0);case Math.abs(d.p2.x):return f(-h,0);case Math.abs(d.p1.y):return f(0,h);case Math.abs(d.p2.y):return f(0,-h)}})();this.pos=this.pos.add(m)},pushOutAll(){p.root.every(this.pushOut)},_checkCollisions(c){p.root.every(c,s=>{this===s||!this.exists()||n[s._id]||this.isColliding(s)&&(this.trigger("collide",s,null),n[s._id]=s)});for(let s in n){let o=n[s];this.isColliding(o)||delete n[s]}},worldArea(){var m,g,y,x;let c=(m=this.area.width)!=null?m:this.width,s=(g=this.area.height)!=null?g:this.height;if(c==null||s==null)throw new Error("failed to get area dimension");let o=f((y=this.scale)!=null?y:1).scale(this.area.scale);c*=o.x,s*=o.y;let d=$e(this.origin||je),h=((x=this.pos)!=null?x:f(0)).add(this.area.offset).sub(d.add(1,1).scale(.5).scale(c,s));return{shape:"rect",p1:h,p2:f(h.x+c,h.y+s)}},screenArea(){let c=this.worldArea();return this.fixed?c:{shape:"rect",p1:it(c.p1),p2:it(c.p2)}}}}a(pi,"area");function De(e){return{color:e.color,opacity:e.opacity,origin:e.origin,outline:e.outline,fixed:e.fixed,shader:U.shaders[e.shader],uniform:e.uniform}}a(De,"getRenderProps");function Ft(e,n={}){var s;let r=null,u=null;function c(o,d,h,m){let g=f(1,1);return h&&m?(g.x=h/(o.width*d.w),g.y=m/(o.height*d.h)):h?(g.x=h/(o.width*d.w),g.y=g.x):m&&(g.y=m/(o.height*d.h),g.x=g.y),g}return a(c,"calcTexScale"),{id:"sprite",width:0,height:0,frame:n.frame||0,quad:n.quad||new k(0,0,1,1),animSpeed:(s=n.animSpeed)!=null?s:1,load(){if(typeof e=="string"?r=U.sprites[e]:r=e,!r)throw new Error(`sprite not found: "${e}"`);let o=P({},r.frames[0]);n.quad&&(o=o.scale(n.quad));let d=c(r.tex,o,n.width,n.height);this.width=r.tex.width*o.w*d.x,this.height=r.tex.height*o.h*d.y,n.anim&&this.play(n.anim)},draw(){dn(D(P({},De(this)),{sprite:r,frame:this.frame,quad:this.quad,flipX:n.flipX,flipY:n.flipY,tiled:n.tiled,width:n.width,height:n.height}))},update(){if(!u)return;let o=r.anims[u.name];if(typeof o=="number"){this.frame=o;return}if(o.speed===0)throw new Error("sprite anim speed cannot be 0");u.timer+=Z()*this.animSpeed,u.timer>=1/u.speed&&(u.timer=0,o.from>o.to?(this.frame--,this.frame<o.to&&(u.loop?this.frame=o.from:(this.frame++,u.onEnd(),this.stop()))):(this.frame++,this.frame>o.to&&(u.loop?this.frame=o.from:(this.frame--,u.onEnd(),this.stop()))))},play(o,d={}){var m,g,y,x,W,O,M;if(!r){Ue(()=>{this.play(o)});return}let h=r.anims[o];if(h==null)throw new Error(`anim not found: ${o}`);u&&this.stop(),u={name:o,timer:0,loop:(g=(m=d.loop)!=null?m:h.loop)!=null?g:!1,pingpong:(x=(y=d.pingpong)!=null?y:h.pingpong)!=null?x:!1,speed:(O=(W=d.speed)!=null?W:h.speed)!=null?O:10,onEnd:(M=d.onEnd)!=null?M:()=>{}},typeof h=="number"?this.frame=h:this.frame=h.from,this.trigger("animPlay",o),this.trigger("animStart",o)},stop(){if(!u)return;let o=u.name;u=null,this.trigger("animEnd",o)},numFrames(){return r?r.frames.length:0},curAnim(){return u==null?void 0:u.name},flipX(o){n.flipX=o},flipY(o){n.flipY=o},onAnimEnd(o,d){return this.on("animEnd",h=>{h===o&&d()})},onAnimStart(o,d){return this.on("animStart",h=>{h===o&&d()})},inspect(){let o="";return typeof e=="string"?o+=JSON.stringify(e):o+="[blob]",o}}}a(Ft,"sprite");function mi(e,n={}){function r(u){var s,o;let c=me(D(P({},De(u)),{text:u.text+"",size:u.textSize,font:u.font,width:n.width&&u.width,letterSpacing:u.letterSpacing,lineSpacing:u.lineSpacing,transform:u.transform,styles:u.styles}));return u.width=c.width/(((s=u.scale)==null?void 0:s.x)||1),u.height=c.height/(((o=u.scale)==null?void 0:o.y)||1),c}return a(r,"update"),{id:"text",text:e,textSize:n.size,font:n.font,width:n.width,height:0,lineSpacing:n.lineSpacing,letterSpacing:n.letterSpacing,transform:n.transform,styles:n.styles,load(){r(this)},draw(){we(r(this))}}}a(mi,"text");function wi(e,n,r={}){return{id:"rect",width:e,height:n,radius:r.radius||0,draw(){Q(D(P({},De(this)),{width:this.width,height:this.height,radius:this.radius}))},inspect(){return`${Math.ceil(this.width)}, ${Math.ceil(this.height)}`}}}a(wi,"rect");function gi(e,n){return{id:"rect",width:e,height:n,draw(){pe(D(P({},De(this)),{width:this.width,height:this.height}))},inspect(){return`${Math.ceil(this.width)}, ${Math.ceil(this.height)}`}}}a(gi,"uvquad");function Ui(e){return{id:"circle",radius:e,draw(){Rt(D(P({},De(this)),{radius:this.radius}))},inspect(){return`${Math.ceil(this.radius)}`}}}a(Ui,"circle");function yi(e=1,n=E(0,0,0)){return{id:"outline",outline:{width:e,color:n}}}a(yi,"outline");function _n(e,n){let r=new $;return e&&n&&r.pushd(new fe(e,n)),{id:"timer",wait(u,c){return r.pushd(new fe(u,c))},update(){r.forEach((u,c)=>{u.tick(Z())&&r.delete(c)})}}}a(_n,"timer");let bi=640,xi=65536;function vi(e={}){var s,o,d;let n=0,r=null,u=null,c=!0;return{id:"body",require:["pos","area"],jumpForce:(s=e.jumpForce)!=null?s:bi,weight:(o=e.weight)!=null?o:1,solid:(d=e.solid)!=null?d:!0,update(){var m;let h=!1;if(r){let g=this.worldArea(),y=r.worldArea(),x=g.p2.y,W=y.p1.y,O=g.p1.x,M=g.p2.x,ee=y.p1.x,te=y.p2.x;!r.exists()||x!==W||M<ee||O>te?(this.trigger("fall",r),r=null,u=null,h=!0):u&&r.pos&&(this.pos=this.pos.add(r.pos.sub(u)),u=r.pos.clone())}if(!r){let g=this.move(0,n);if(g)if(g.isBottom()){r=g.target;let y=n;n=0,r.pos&&(u=r.pos.clone()),h||(this.trigger("ground",r),c=!0)}else g.isTop()&&(n=0,this.trigger("headbutt",g.target));n+=kn()*this.weight*Z(),n=Math.min(n,(m=e.maxVel)!=null?m:xi)}},curPlatform(){return r},isGrounded(){return r!==null},grounded(){return B("grounded()","isGrounded()"),this.isGrounded()},isFalling(){return n>0},falling(){return B("falling()","isFalling()"),this.isFalling()},jump(h){r=null,u=null,n=-h||-this.jumpForce},doubleJump(h){this.isGrounded()?this.jump(h):c&&(c=!1,this.jump(h),this.trigger("doubleJump"))},onGround(h){return this.on("ground",h)},onFall(h){return this.on("fall",h)},onHeadbutt(h){return this.on("headbutt",h)},onDoubleJump(h){return this.on("doubleJump",h)}}}a(vi,"body");function Ei(e,n={}){let r=U.shaders[e];return{id:"shader",shader:e,uniform:n}}a(Ei,"shader");function Ti(){return{id:"solid",require:["area"],solid:!0}}a(Ti,"solid");function Si(){return{id:"fixed",fixed:!0}}a(Si,"fixed");function kt(){return{id:"stay",stay:!0}}a(kt,"stay");function Ci(e){if(e==null)throw new Error("health() requires the initial amount of hp");return{id:"health",hurt(n=1){this.setHP(e-n),this.trigger("hurt")},heal(n=1){this.setHP(e+n),this.trigger("heal")},hp(){return e},setHP(n){e=n,e<=0&&this.trigger("death")},onHurt(n){return this.on("hurt",n)},onHeal(n){return this.on("heal",n)},onDeath(n){return this.on("death",n)},inspect(){return`${e}`}}}a(Ci,"health");function Ri(e,n={}){var s;if(e==null)throw new Error("lifespan() requires time");let r=0,u=(s=n.fade)!=null?s:0,c=Math.max(e-u,0);return{id:"lifespan",update(){r+=Z(),r>=c&&(this.opacity=dt(r,c,e,1,0)),r>=e&&this.destroy()}}}a(Ri,"lifespan");function Wi(e,n,r){if(!e)throw new Error("state() requires an initial state");let u={};function c(d){u[d]||(u[d]={enter:[],leave:[],update:[],draw:[]})}a(c,"initStateHook");function s(d,h,m){c(h),u[h][d].push(m)}a(s,"on");function o(d,h,...m){c(h),u[h][d].forEach(g=>g(...m))}return a(o,"trigger"),{id:"state",state:e,enterState(d,...h){if(n&&!n.includes(d))throw new Error(`State not found: ${d}`);let m=this.state;if(r){if(!(r==null?void 0:r[m]))return;let g=typeof r[m]=="string"?[r[m]]:r[m];if(!g.includes(d))throw new Error(`Cannot transition state from "${m}" to "${d}". Available transitions: ${g.map(y=>`"${y}"`).join(", ")}`)}o("leave",m,...h),this.state=d,o("enter",d,...h),o("enter",`${m} -> ${d}`,...h)},onStateTransition(d,h,m){s("enter",`${d} -> ${h}`,m)},onStateEnter(d,h){s("enter",d,h)},onStateUpdate(d,h){s("update",d,h)},onStateDraw(d,h){s("draw",d,h)},onStateLeave(d,h){s("leave",d,h)},update(){o("update",this.state)},draw(){o("draw",this.state)},inspect(){return this.state}}}a(Wi,"state");function Ue(e){t.loaded?e():p.on("load",e)}a(Ue,"onLoad");function Mi(e,n){p.scenes[e]=n}a(Mi,"scene");function Li(e,...n){if(!p.scenes[e])throw new Error(`scene not found: ${e}`);let r=p.on("updateStart",()=>{p.events={},p.objEvents={add:new $,update:new $,draw:new $,destroy:new $},p.root.every(u=>{u.is("stay")||p.root.remove(u)}),p.timers=new $,p.cam={pos:at(),scale:f(1),angle:0,shake:0,transform:new R},p.layers={},p.defLayer=null,p.gravity=Fr,p.scenes[e](...n),i.debug!==!1&&Vn(),i.burp&&Fn(),r()})}a(Li,"go");function qi(e,n){try{return JSON.parse(window.localStorage[e])}catch(r){return n?(Bn(e,n),n):null}}a(qi,"getData");function Bn(e,n){window.localStorage[e]=JSON.stringify(n)}a(Bn,"setData");function Nn(e){let n=e(ye);for(let r in n)ye[r]=n[r],i.global!==!1&&(window[r]=n[r]);return ye}a(Nn,"plug");function at(){return f(F()/2,G()/2)}a(at,"center");function Pi(e,n){return{id:"grid",gridPos:n.clone(),setGridPos(...r){let u=f(...r);this.gridPos=u.clone(),this.pos=f(e.offset().x+this.gridPos.x*e.gridWidth(),e.offset().y+this.gridPos.y*e.gridHeight())},moveLeft(){this.setGridPos(this.gridPos.add(f(-1,0)))},moveRight(){this.setGridPos(this.gridPos.add(f(1,0)))},moveUp(){this.setGridPos(this.gridPos.add(f(0,-1)))},moveDown(){this.setGridPos(this.gridPos.add(f(0,1)))}}}a(Pi,"grid");function Di(e,n){if(!n.width||!n.height)throw new Error("Must provide level grid width & height.");let r=[],u=f(n.pos||f(0)),c=0,s={offset(){return u.clone()},gridWidth(){return n.width},gridHeight(){return n.height},getPos(...o){let d=f(...o);return f(u.x+d.x*n.width,u.y+d.y*n.height)},spawn(o,...d){let h=f(...d),m=(()=>{if(n[o]){if(typeof n[o]!="function")throw new Error("level symbol def must be a function returning a component list");return n[o](h)}else if(n.any)return n.any(o,h)})();if(!m)return;let g=f(u.x+h.x*n.width,u.y+h.y*n.height);for(let x of m)if(x.id==="pos"){g.x+=x.pos.x,g.y+=x.pos.y;break}m.push(st(g)),m.push(Pi(this,h));let y=p.root.add(m);return r.push(y),y},width(){return c*n.width},height(){return e.length*n.height},destroy(){for(let o of r)o.destroy()}};return e.forEach((o,d)=>{let h=o.split("");c=Math.max(h.length,c),h.forEach((m,g)=>{s.spawn(m,f(g,d))})}),s}a(Di,"addLevel");function jn(e){let n=t.canvas.captureStream(e),r=w.ctx.createMediaStreamDestination();w.masterNode.connect(r);let u=r.stream,[c]=u.getAudioTracks(),s=new MediaRecorder(n),o=[];return s.ondataavailable=d=>{d.data.size>0&&o.push(d.data)},s.onerror=d=>{w.masterNode.disconnect(r),n.getTracks().forEach(h=>h.stop())},s.start(),{resume(){s.resume()},pause(){s.pause()},download(d="kaboom.mp4"){s.onstop=()=>{ur(new Blob(o,{type:"video/mp4"}),d)},s.stop(),w.masterNode.disconnect(r),n.getTracks().forEach(h=>h.stop())}}}a(jn,"record");function Ai(){B("focus()","canvas.focus()"),t.canvas.focus()}a(Ai,"focus");function Yn(){return document.activeElement===t.canvas}a(Yn,"isFocused");function Gt(e){return p.root.add(e)}a(Gt,"add");function Oi(e){return p.root.readd(e)}a(Oi,"readd");function ut(e){return p.root.remove(e)}a(ut,"destroy");function Ii(e){return p.root.removeAll(e)}a(Ii,"destroyAll");function Vi(...e){return p.root.get(...e)}a(Vi,"get");function Fi(...e){return p.root.every(...e)}a(Fi,"every");function ki(...e){return p.root.revery(...e)}a(ki,"revery");function $n(e=2,n=1){let r=0;return{id:"explode",require:["scale"],update(){let u=Math.sin(r*e)*n;u<0&&ut(this),this.scale=f(u),r+=Z()}}}a($n,"explode");let Xn=null,Kn=null;J(null,qr).then(e=>Xn=e),J(null,Pr).then(e=>Kn=e);function Gi(e,n={}){var o,d;let r=(n.speed||1)*5,u=n.scale||1,c=Gt([st(e),Ft(Kn),ot(0),kt(),It("center"),$n(r,u),...((o=n.boomComps)!=null?o:()=>[])()]),s=Gt([st(e),Ft(Xn),ot(0),kt(),It("center"),_n(.4/r,()=>s.use($n(r,u))),...((d=n.kaComps)!=null?d:()=>[])()]);return{destroy(){ut(s),ut(c)}}}a(Gi,"addKaboom");function Vs(){return t.numFrames}a(Vs,"frames");function Hn(){p.trigger("updateStart"),p.timers.forEach((e,n)=>{e.time-=Z(),e.time<=0&&(e.action(),p.timers.delete(n))}),p.root.update()}a(Hn,"updateFrame");function _i(){let e=p.cam,n=L.fromAngle(Ge(0,360)).scale(e.shake);e.shake=Fe(e.shake,0,5*Z()),e.transform=new R().translate(at()).scale(e.scale).rotateZ(e.angle).translate(e.pos.scale(-1).add(n)),p.root.draw()}a(_i,"drawFrame");function Bi(){let e=A();if(e===1)t.loaded=!0,p.trigger("load");else{let n=F()/2,r=24/t.scale,u=f(F()/2,G()/2).sub(f(n/2,r/2));Q({pos:f(0),width:F(),height:G(),color:E(0,0,0)}),Q({pos:u,width:n,height:r,fill:!1,outline:{width:4/t.scale}}),Q({pos:u,width:n*e,height:r})}}a(Bi,"drawLoadScreen");function zn(e,n){let r=f(8);re(),I(e),ne(1/t.scale);let u=me({text:n,font:U.fonts[sn],size:16,pos:r,color:E(255,255,255),fixed:!0}),c=u.width+r.x*2,s=u.height+r.x*2;e.x+c/t.scale>=F()&&I(f(-c,0)),e.y+s/t.scale>=G()&&I(f(0,-s)),Q({width:c,height:s,color:E(0,0,0),radius:4,opacity:.8,fixed:!0}),we(u),ie()}a(zn,"drawInspectText");function Jn(){var e,n;if(C.inspect){let r=null,u=v.fromArray((e=i.inspectColor)!=null?e:[0,0,255]);if(p.root.every(c=>{if(!c.area||c.hidden)return;r||c.isHovering()&&(r=c);let s=r===c?8:4,o=c.worldArea(),d=o.p2.x-o.p1.x,h=o.p2.y-o.p1.y;Q({pos:o.p1,width:d,height:h,outline:{width:s,color:u},fill:!1,fixed:c.fixed})}),r){let c=[],s=r.inspect();for(let o in s)s[o]?c.push(`${o}: ${s[o]}`):c.push(`${o}`);zn(K(),c.join(`
`))}zn(f(8/t.scale),`FPS: ${C.fps()}`)}if(C.paused){re(),I(F(),0),ne(1/t.scale),I(-8,8);let r=32;Q({width:r,height:r,origin:"topright",color:E(0,0,0),opacity:.8,radius:4,fixed:!0});for(let u=1;u<=2;u++)Q({width:4,height:r*.6,origin:"center",pos:f(-r/3*u,r*.5),color:E(255,255,255),radius:2,fixed:!0});ie()}if(C.timeScale!==1){re(),I(F(),G()),ne(1/t.scale),I(-8,-8);let r=8,u=me({text:C.timeScale.toFixed(1),font:U.fonts[sn],size:16,color:E(255,255,255),pos:f(-r),origin:"botright",fixed:!0});Q({width:u.width+r*2+r*4,height:u.height+r*2,origin:"botright",color:E(0,0,0),opacity:.8,radius:4,fixed:!0});for(let c=0;c<2;c++){let s=C.timeScale<1;pn({p1:f(-u.width-r*(s?2:3.5),-r),p2:f(-u.width-r*(s?2:3.5),-r-u.height),p3:f(-u.width-r*(s?3.5:2),-r-u.height/2),pos:f(-c*r*1+(s?-r*.5:0),0),color:E(255,255,255),fixed:!0})}we(u),ie()}if(C.curRecording&&(re(),I(0,G()),ne(1/t.scale),I(24,-24),Rt({radius:12,color:E(255,0,0),opacity:Kt(0,1,rt()*4),fixed:!0}),ie()),C.showLog&&p.logs.length>0){re(),I(0,G()),ne(1/t.scale),I(8,-8);let r=8,u=(n=i.logMax)!=null?n:1;p.logs.length>u&&(p.logs=p.logs.slice(0,u));let c=me({text:p.logs.join(`
`),font:U.fonts[sn],pos:f(r,-r),origin:"botleft",size:16,width:F()*t.scale*.6,lineSpacing:r/2,fixed:!0,styles:{time:{color:E(127,127,127)},info:{color:E(255,255,255)},error:{color:E(255,0,127)}}});Q({width:c.width+r*2,height:c.height+r*2,origin:"botleft",color:E(0,0,0),radius:4,opacity:.8,fixed:!0}),we(c),ie()}}a(Jn,"drawDebug"),i.debug!==!1&&Vn(),i.burp&&Fn(),window.addEventListener("error",e=>{C.error(`Error: ${e.error.message}`),Jr(),Qn(()=>{A()===1&&(ze(),Jn(),Je())})});function Qn(e){let n=a(r=>{if(document.visibilityState!=="visible"){t.loopID=requestAnimationFrame(n);return}let u=r/1e3,c=u-t.realTime;t.realTime=u,t.skipTime||(t.dt=c,t.time+=t.dt,t.fpsCounter.tick(t.dt)),t.skipTime=!1,t.numFrames++,e();for(let s in t.keyStates)t.keyStates[s]=Gr(t.keyStates[s]);for(let s in t.mouseStates)t.mouseStates[s]=Gr(t.mouseStates[s]);t.charInputted=[],t.isMouseMoved=!1,t.isKeyPressed=!1,t.isKeyPressedRepeat=!1,t.isKeyReleased=!1,t.loopID=requestAnimationFrame(n)},"frame");t.stopped=!1,t.loopID=requestAnimationFrame(n)}a(Qn,"run"),Qn(()=>{yn(),t.loaded?(p.trigger("input"),C.paused||Hn(),ze(),_i(),i.debug!==!1&&Jn(),Je()):(ze(),Bi(),Je())}),X("apl386",Sr,45,74),X("apl386o",Cr,45,74),X("sink",Rr,6,8,{chars:"\u2588\u263A\u263B\u2665\u2666\u2663\u2660\u25CF\u25CB\u25AA\u25A1\u25A0\u25D8\u266A\u266B\u2261\u25BA\u25C4\u2302\xDE\xC0\xDF\xD7\xA5\u2191\u2193\u2192\u2190\u25CC\u25CF\u25BC\u25B2 !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~\u03A7\u2591\u2592\u2593\u1E00\u1E01\u1E02\u2502\u252C\u2524\u250C\u2510\u1E03\u1E04\u253C\u1E05\u1E06\u1E07\u1E08\u1E09\u1E0A\u1E0B\u1E0C\u2500\u251C\u2534\u2514\u2518\u1E0D\u1E0E\u205E\u1E0F\u1E10\u1E11\u1E12\u1E13\u1E14\u1E15\u1E16\u1E17\u1E18\u2584\u1E19\u1E1A\u1E1B\u1E1C\u2026\u1E1D\u1E1E\u1E1F\u1E20\u1E21\u1E22\u1E23\u1E24\u1E25\u1E26\u258C\u2590\u1E27\u1E28\u1E29\u1E2A\u1E2B\u1E2C\u1E2D\u1E2E\u1E2F\u1E30\u1E31\u1E32\u1E33\u1E34\u1E35\u1E36\u1E37\u1E38\u1E39\u1E3A\u1E3B\u1E3C\u1E3D\u1E3E\u1E3F\u1E40\u1E41\u1E42\u1E43\u1E44\u1E45\u1E46\u1E47\u1E48\u1E49\u1E4A\u1E4B\u1E4C\u1E4D\u1E4E\u1E4F\u1E50\u1E51\u1E52\u1E53\u1E54\u1E55\u1E56\u1E57\u1E58\u1E59\u1E5A\u1E5B\u1E5C\u1E5D\u1E5E\u1E5F\u1E60\u1E61\u1E62\u1E63\u1E64\u1E65\u1E66\u1E67\u1E68\u1E69\u1E6A\u1E6B\u1E6C\u1E6D\u1E6E\u1E6F\u1E70\u1E71\u1E72\u1E73\u1E74\u1E75\u1E76\u1E77\u1E78\u1E79\u1E7A\u1E7B\u1E7C"}),X("sinko",Wr,8,10),ze(),Je();let ye={loadRoot:q,loadSprite:J,loadSpriteAtlas:Ee,loadSound:Ce,loadFont:X,loadShader:Se,loadAseprite:Tt,loadPedit:Xe,loadBean:Br,load:S,width:F,height:G,center:at,dt:Z,time:rt,screenshot:xn,record:jn,isFocused:Yn,focus:Ai,cursor:vn,regCursor:si,fullscreen:zr,isFullscreen:En,onLoad:Ue,isTouch:()=>t.isTouch,layers:Zr,camPos:ei,camScale:ti,camRot:ni,shake:ri,toScreen:it,toWorld:qt,gravity:kn,add:Gt,readd:Oi,destroy:ut,destroyAll:Ii,get:Vi,every:Fi,revery:ki,pos:st,scale:ot,rotate:oi,color:ai,opacity:ui,origin:It,layer:ci,area:pi,sprite:Ft,text:mi,rect:wi,circle:Ui,uvquad:gi,outline:yi,body:vi,shader:Ei,timer:_n,solid:Ti,fixed:Si,stay:kt,health:Ci,lifespan:Ri,z:li,move:di,outview:Vt,cleanup:fi,follow:hi,state:Wi,on:qe,onUpdate:Pe,onDraw:Sn,onCollide:Cn,onClick:Rn,onHover:Wn,onKeyDown:Pt,onKeyPress:H,onKeyPressRepeat:Dt,onKeyRelease:At,onMouseDown:Ln,onMousePress:Ot,onMouseRelease:qn,onMouseMove:Pn,onCharInput:Dn,onTouchStart:An,onTouchMove:On,onTouchEnd:In,mousePos:K,mouseWorldPos:Qr,mouseDeltaPos:bn,isKeyDown:Lt,isKeyPressed:Le,isKeyPressedRepeat:Mt,isKeyReleased:nt,isMouseDown:et,isMousePressed:Me,isMouseReleased:tt,isMouseMoved:Wt,loop:ii,wait:Mn,play:Ke,volume:Nr,burp:cn,audioCtx:w.ctx,Timer:fe,Line:he,Rect:Be,Circle:bt,Vec2:L,Color:v,Mat4:R,Quad:k,RNG:be,rng:wr,rand:Ge,randi:zt,randSeed:gr,vec2:f,rgb:E,hsl2rgb:fr,quad:pr,choose:yr,chance:Ur,lerp:Fe,map:dt,mapc:dr,wave:Kt,deg2rad:ue,rad2deg:Xt,testAreaRect:gt,testAreaLine:en,testAreaCircle:tn,testAreaPolygon:nn,testAreaPoint:Ut,testAreaArea:rn,testLineLine:le,testRectRect:Jt,testRectLine:ft,testRectPoint:ae,testPolygonPoint:xe,testLinePolygon:_e,testPolygonPolygon:wt,testCircleCircle:Zt,testCirclePoint:mt,testRectPolygon:pt,drawSprite:dn,drawText:Kr,formatText:me,drawRect:Q,drawLine:We,drawLines:fn,drawTriangle:pn,drawCircle:Rt,drawEllipse:mn,drawUVQuad:pe,drawPolygon:Ze,drawFormattedText:we,pushTransform:re,popTransform:ie,pushTranslate:I,pushRotate:Qe,pushScale:ne,debug:C,scene:Mi,go:Li,addLevel:Di,getData:qi,setData:Bn,plug:Nn,ASCII_CHARS:Or,CP437_CHARS:gs,canvas:t.canvas,addKaboom:Gi,LEFT:L.LEFT,RIGHT:L.RIGHT,UP:L.UP,DOWN:L.DOWN,RED:v.RED,GREEN:v.GREEN,BLUE:v.BLUE,YELLOW:v.YELLOW,MAGENTA:v.MAGENTA,CYAN:v.CYAN,WHITE:v.WHITE,BLACK:v.BLACK,keyIsDown:T("keyIsDown()","isKeyDown()",Lt),keyIsPressed:T("keyIsPressed()","isKeyPressed()",Le),keyIsPressedRep:T("keyIsPressedRep()","isKeyPressedRepeat()",Mt),keyIsReleased:T("keyIsReleased()","isKeyReleased()",nt),mouseIsDown:T("mouseIsDown()","isMouseDown()",et),mouseIsClicked:T("mouseIsClicked()","isMousePressed()",Me),mouseIsReleased:T("mouseIsReleased()","isMouseReleased()",tt),mouseIsMoved:T("mouseIsMoved()","isMouseMoved()",Wt),dir:T("dir()","Vec2.fromAngle()",L.fromAngle),action:T("action()","onUpdate()",Pe),render:T("render()","onDraw()",Sn),collides:T("collides()","onCollide()",Cn),clicks:T("clicks()","onClick()",Rn),hovers:T("hovers()","onHover()",Wn),keyDown:T("keyDown()","onKeyDown()",Pt),keyPress:T("keyPress()","onKeyPress()",H),keyPressRep:T("keyPressRep()","onKeyPressRepeat()",Dt),keyRelease:T("keyRelease()","onKeyRelease()",At),mouseDown:T("mouseDown()","onMouseDown()",Ln),mouseClick:T("mouseClick()","onMousePress()",Ot),mouseRelease:T("mouseRelease()","onMouseRelease()",qn),mouseMove:T("mouseMove()","onMouseMove()",Pn),charInput:T("charInput()","onCharInput()",Dn),touchStart:T("touchStart()","onTouchStart()",An),touchMove:T("touchMove()","onTouchMove()",On),touchEnd:T("touchEnd()","onTouchEnd()",In),focused:T("focused()","isFocused()",Yn),ready:T("ready()","onLoad()",Ue)};if(i.plugins&&i.plugins.forEach(Nn),i.global!==!1)for(let e in ye)window[e]=ye[e];return ye},"default");return is(qs);})();
